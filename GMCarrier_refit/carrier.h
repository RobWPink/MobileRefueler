...
#define mbSlaveAddr 4 //remote
#define mbSlaveCarrierAddr 3 //local
#define numBanks 4
volatile int MOVING_AVG_SIZE = 10;
volatile int STALL_THRESHOLD = 10;
volatile int MIN_ALLOWED_PRESSURE = 1000;
volatile int DELTA_PSI_TIME = 3000;
volatile int STALL_CONFIRMATION_COUNT = 3;
